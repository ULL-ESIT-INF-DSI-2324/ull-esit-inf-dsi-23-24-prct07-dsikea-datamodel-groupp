...
let StockInicial: Mueble[] = [
  new Mueble( 1, "garugabksv", "Mesa pequeña negra", ["madera"], [80, 160, 50], 38.99, 1), 
  new Mueble( 2, "ksvis", "Comoda negra tamaño estandar", ["madera", "acero"], [30, 62, 70], 54.99, 1), 
  new Mueble( 3, "loqufdca", "Sofa-cama grande con forma de L", ["cuero", "espuma de poliuretano"], [220, 325, 91], 644.99, 1), 
  new Mueble( 4, "ewsqv", "Silla de oficina con tapiz blanco", ["acero", "piel natural"], [66, 60, 108], 67.99, 1), 
  new Mueble( 5, "apoiuwe", "Mesa de noche de madera clara", ["madera"], [38, 42, 56], 74.99, 1), 
  new Mueble( 6, "piwuu", "Cuadro portaretrato de pequeñas dimesiones", ["pvc", "cristal"], [2.40, 10, 15], 14.99, 1), 
  new Mueble( 7, "vuqloa", "Espejo de tamaño cuerpo completo", ["acero", "cristal"], [68, 5.2, 180], 244.99, 1), 
  new Mueble( 8, "swyia", "Cama individual tamaño estandar", ["polialgodon", "acero", "madera"], [80, 53, 190], 238.99, 1), 
  new Mueble( 9, "armfwa", "Escritorio de grandes dimensiones", ["madera", "metal"], [168, 125, 73], 157.99, 1), 
  new Mueble(10, "regnskur", "Lampara para techo ovalado verde", ["madera"], [50, 70, 30], 24.99, 1), 
  new Mueble(11, "skadis", "Tablero perforado para colocar cosas", ["fibras", "pinturas acrilicas"], [12, 13, 14], 18.99, 1), 
  new Mueble(12, "plafkq", "Silla acolchada de tonos claros ", ["piel sintetica"], [62, 58, 102], 27.99, 1), 
  new Mueble(13, "kosv", "Cama de matrimonio de matrimonio 200x200", ["polialgodon", "acero", "madera"], [200, 56, 220], 538.99, 1), 
  new Mueble(14, "aariqa", "Lampara de pie negra", ["acero"], [32, 54, 147], 31.99, 1), 
  new Mueble(15, "gjatta", "Caja morada para almacenar enseres", ["poliester"], [18, 25, 15], 6.99, 1), 
  new Mueble(16, "pluttis", "Reloj de pared estilo clasico", ["cristal", "pvc"], [6.8, 28, 28], 4.99, 1), 
  new Mueble(17, "opotsoa", "Jarron de cristal ", ["cristal"], [12, 12, 17], 2.99, 1), 
  new Mueble(18, "mydale", "Esctructura de madera para literas", ["madera"], [97, 206, 157], 289.99, 1), 
  new Mueble(19, "storhaga", "Lampara de mesa", ["acero"], [15, 15, 44], 54.99, 1), 
  new Mueble(20, "nymane", "Espejo de baño ", ["cristal"], [3.1, 50, 60], 13.99, 1), 
];
...
let TransacccionInicial: Transaccion[] = [
  new Transaccion(1, "Proveedor", [{mueble: new Mueble(21, "nymane", "Espejo de baño ", ["cristal"], [3.1, 50, 60], 13.99, 1), cantidad: 1}], 0 , "Obtener", new Date(21-3-2001), 60)
]; 

let stockDisponible: Stock = new jsonStock(StockInicial, clientesIniciales, ProveedoresIniciales, TransacccionInicial);
  ...
  .then(answers => {
    switch(answers["command"]){
      case comandosClientes.nuevo_cliente:
        ...
        stockDisponible = new jsonStock(StockInicial, clientesAnadidos, ProveedoresIniciales, TransacccionInicial);
